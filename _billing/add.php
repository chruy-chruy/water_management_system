...
<form class="row g-3" method="POST" action="create.php">
  ...
  <div class="col-md-4">
    ...
    <input required  type="number" step=0.0001 class="form-control" name="current_reading" id="current_reading" >
  ...
  <div class="col-md-4">
    <label for="rate" class="form-label">Total Price</label>
    <input required  type="number" step=0.01  class="form-control" name="total_price" id="total_price" placeholder="00.00" >
  </div>
